<template>
  ...
  <div class="px-6 md:px-0">
    ...
    <div class="bg-white w-full md:w-2/3 lg:w-1/3 md:mx-auto mt-4 px-10 py-6 rounded-xl shadow-md">
      ...
      <div class="mt-10">
        ...
        <div @click="doLogin()">
          <div class="w-full my-4 py-2 rounded-full text-center text-white border-2 bg-rangmod-purple shadow-sm cursor-pointer transition-all hover:bg-transparent hover:border-rangmod-purple hover:text-rangmod-purple hover:shadow-none">
            เข้าสู่ระบบ
          </div>
        </div>
        ...
        <div class="my-4 py-2 text-center text-rangmod-purple/70 transition-all ">

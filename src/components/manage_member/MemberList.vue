  ...
  <div class="bg-white rounded-xl text-rangmod-black font-primary my-10 px-5 shadow-md py-2">
    ...
    <table class="w-full text-rangmod-black mb-10 hidden md:table">
      ...
      >
        ...
        <td class="text-center py-4 whitespace-nowrap">{{member.name}} {{member.surname}}</td>
    ...
    <div class="flex flex-col md:hidden mb-10">
      ...
      >
        ...
        <div class="text-center py-4 text-rangmod-purple cursor-pointer transition-all hover:font-bold" @click="showDetail(member.code)">
          <div>รายละเอียด</div>
        </div>    
      </div>
    ...
    <transition>
      ...
      >
        ...
        <div class="w-11/12 lg:w-1/2 h-full mx-auto my-10 bg-white px-5 py-8 rounded-xl shadow-xl overflow-y-scroll no-scrollbar">
          <!-- Closed -->
          ...
          <div class="text-2xl text-rangmod-purple mb-5">ทำประวัติผู้พักอาศัย</div>
